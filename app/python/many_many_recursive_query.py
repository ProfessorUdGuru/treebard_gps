...
# do something about the case where user inputs nonexistent place id
#
# use above to generate nestings on demand and don't store the nestings, just store the info needed to recreate the nestings

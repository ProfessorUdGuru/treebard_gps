...
class NuclearFamiliesTable(Frame):
    ...
    def add_child(self):
        ...
        # ppid = cur.fetchone()[0]
        # cur.execute(insert_finding_couple, (birth_id, ppid))
    ...
    def link_partners_dialog(self, cur, conn, inwidg):
        ...
        def cancel_link_partner():
            ...
            self.null_partner_replacer.destroy()
            self.cancel_link_partner_pressed = False
        # function call was deleted after 20220405, don't know why 
    ...
    def update_parent(self, final, conn, cur, inwidg, column=None, kin_type=None, alt_parent=None):
        ...
        def delete_parent(column):
            if column == 1:
                cur.execute(update_finding_person_1, (None, finding_id))
            elif column == 3:
    ...
    def make_parent(self, column, finding_id, widg, conn, cur):
        ...
        if column == 1:
            cur.execute(update_finding_person_1, (new_parent_id, finding_id))
        elif column == 3:

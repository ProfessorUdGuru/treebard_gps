...
# '''
    # This widget works well but the code might be updated by looking at
    # how the dropdown works in Bilbobox. For a model of the new
    # configurable scrollbar which might replace the weird use of AutofillScrollbar
    # in this class, see roles.py.
# '''

...
class Test:
    ...
    def __init__(self):
        ...
        self.gedcom_test = Gedcom(self.filename)
        self.info = 'names'
    ...
    def surname(self,match):
        ...
        self.print_header("Surname - {}".format(match))
        # self.print_header('Surname - %s' % (match))
        for e in self.gedcom_test.element_list():
            if e.individual():
    ...
    def missing(self):
        ...
        for e in self.gedcom_test.element_list():
            if e.value().startswith('@'):
                f = self.gedcom_test.element_dict().get(e.value(),None)
                if f == None:
                    print(e.value())

...
main_help_msg = (
    ...
    ("There are several ways to try a color scheme before applying it. The color preferences tab is a preview area. If you click on one of the color swatches, the preview area will change colors so you can preview the color scheme. Or you can Tab through the swatches to see the selected swatch change, and the preview area change with it. But the easiest way to preview many color samples quickly is to traverse the swatches with the arrow keys. The up and down arrow traverse within a column, while the left and right arrows traverse by row, and from row to row. While traversing with the arrow keys, the scrollbar won't be needed; the swatches area will autoscroll as needed.\n\nIn either case, no changes will be made to the application in general till you press APPLY.",
        "Color Scheme Tab: Preview and Traversal"),
    ("The COPY button is used to copy an existing color scheme so you can adjust one or more parts of it and save it as a new color scheme. You can even delete the original, unless it's a built-in color scheme, by highlighting the swatch and pressing the Delete key. To copy a color scheme, highlight the corresponding swatch either by clicking on it or tabbing into it, then press COPY. The hex numbers for the colors in that scheme will be automatically copied into the four inputs at the bottom of the Color Scheme Preferences Tab. To change any of the four colors, double-click in the input to open a color picker, or if you know the hex number for the color you want, type or paste it into the field.",
        "Color Scheme Tab: COPY Button"),
    ("The APPLY button should be used after trying a color scheme that you decide you like. The trial scheme will be shown on the Color Scheme Preferences Tab only. To apply this scheme to the whole application instantly, press APPLY.",
        "Color Scheme Tab: APPLY Button"),
    ("The CREATE NEW COLOR SAMPLE Button at the bottom of the Color Scheme Preferences Tab will create a new swatch at the far right end of the color scheme strip at the top. The new swatch will be based on hex color values which you can fill into the four inputs above the button, either by typing or pasting color values that you know, or by selecting a swatch and pressing the COPY button, or by double-clicking in an input to open a color picker.",
        "Color Scheme Tab: New Color Scheme Button"),
    ("If you want a dark theme, choose three different relatively dark colors. I usually make this background color 1 the darkest, but it's up to you. By keeping the number of colors down, this system is fast and easy to use, and the results can be beautiful, simple, and easy to read. Primary colors are not recommended because they fatigue the eye faster than muddy or earthtone colors, but it's completely up to you. For light-colored themes, you're on your own, Treebard can show those too, but I can't look at them, it's like looking at bare lightbulbs and has the same effect on your eyes, besides using more power. For inspiration you can browse online resources such as http://colorhunt.co where color lovers post thousands of color schemes, or you can browse websites taking screenshots from themes you like, paste them into the graphics program, and get your graphics program to tell you what the hex numbers for the colors are.",

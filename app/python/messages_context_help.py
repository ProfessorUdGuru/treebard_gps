...
main_help_msg = (
    ...
    ("There are two ways to try a color sample. If you click on one of the swatches with the mouse, the sample area will change colors instantly so you can see your choice in action, and the TRY button won't be needed. Or you can Tab through the swatches and click the TRY button with the mouse when the color scheme you want to try is selected. In either case, no changes will be made to the application in general till you press APPLY.",
